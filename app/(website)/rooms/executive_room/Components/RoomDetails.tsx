      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {/* Header Information */}
            <div>
              <p className="text-[#c5a37f] text-2xl font-serif mb-2">₹4500</p>
              <h1 className="text-4xl md:text-5xl font-serif text-[#1a1a1a] mb-6">Executive Room</h1>
              <div className="flex gap-6 text-gray-400 text-sm mb-8">
                 <span className="flex items-center gap-1">📏 200 sq.ft (19 sq.mt)</span>
              ...
              <p className="text-gray-500 leading-relaxed text-base">
                ...
                Whether you are here for business or leisure, our Executive Room provides the perfect sanctuary.
              </p>
            </div>

            {/* Visual Gallery Grid */}
            <div className="grid grid-cols-2 gap-4 h-[300px] md:h-fit overflow-hidden">
              <img 
                src="/hotel/DSC_0273.JPG" 
                className="w-full h-full object-cover rounded-2xl shadow-sm" 
                alt="Room View 1" 
              />
              <img 
                src="/hotel/DSC_0283.JPG" 
                className="w-full h-full object-cover rounded-2xl shadow-sm" 
                alt="Room View 2" 
              />
            </div>
            ...
            <div>
              <h1 className="text-2xl font-serif mb-8 border-b border-gray-100 pb-4 text-black">Room Features</h1>
              <div className="relative w-full h-64 md:h-96 mb-8 rounded-2xl overflow-hidden">
                <img 
                  src="/hotel/DSC_0279.JPG" 
          ...
          <div className="relative">
            <div className="lg:sticky lg:top-24">
              <BookingForm initialRoomType="Executive Room" />
            </div>
          </div>
